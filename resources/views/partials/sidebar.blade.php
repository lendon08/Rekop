<aside id="sidebar" class="fixed left-0 z-50 flex-col flex-shrink-0 hidden w-16 h-full font-normal duration-75 lg:flex transition-width" aria-label="Sidebar">
