    ...
    <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
      <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-20">
        <ul class="pb-2 space-y-2">
          ...
          <li>
            <a href="{{ route('dashboard') }}" data-tooltip-target="tooltip-dashboard" data-tooltip-placement="right" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group">
          ...
          <li>
            <a href="{{ route('companies') }}" data-tooltip-target="tooltip-companies" data-tooltip-placement="right" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group">
          ...
          <li>
          <li>
            <a href="{{ route('call-histories') }}" data-tooltip-target="tooltip-call-history" data-tooltip-placement="right"  class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group">
            ...
            <a href="{{ route('phone-settings') }}" data-tooltip-target="tooltip-phonesetting" data-tooltip-placement="right"  class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group ">
          ...
          <!-- <li>
            ...
            <ul id="dropdown-layouts" class="hidden py-2 space-y-2">
              <li>
                <a href="#layouts/stacked/" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100">Clients</a>
              </li>
              <li>
                <a href="#layouts/sidebar/" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100">Companies</a>
              </li>
            </ul>
          </li> -->
