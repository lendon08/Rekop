<div>
    ...
    <form class="mt-8 space-y-6" wire:submit="submit">
        ...
        <div>
            ...
            <x-atoms.forms.textbox type="text" name="name" id="name" wire:model="name"/>
        ...
        <x-atoms.forms.button variant="success" type="submit">Register to your account</x-atoms.forms.button>
