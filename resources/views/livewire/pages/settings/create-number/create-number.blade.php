                        ...
                        <label
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    x-mask="999"
                                    size="3"
                                    wire:model.debounce.500ms="areaCode"
                                ...
                                <div class="my-2">
                                    ...
                                    @else
                                    @foreach($availableNumbers as $numbers)
                                    <div class="flex-auto me-4">
                                        <input id="inline-checked-radio" type="radio" value="" name="inline-radio-group" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-2">
                                        <label for="inline-checked-radio" class="ms-2 text-sm font-medium">{{ $numbers }}</label>
                                    </div>
                                    @endforeach
                                    @endif
                                    @endif
