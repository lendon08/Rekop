                ...
                <div>
                    ...
                    <div class="my-2">
                        ...
                        @if(strlen($areaCode) == 3)
                            ...
                            <div class="flex-auto me-4" wire:key="item-{{ $key }}">
                                <input id="inline-checked-radio" type="radio" wire:model.live="selectedNumber" value="{{ $numbers}}" name="inline-radio-group" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-2">
