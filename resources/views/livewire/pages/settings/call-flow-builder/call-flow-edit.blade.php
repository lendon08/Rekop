<main class="space-y-4">
    ...
    <div class="flex flex-col w-1/2 justify-center mx-auto">
        <div class="flex flex-col text-center ">
            ...
            <div>
                ...
                <label class="inline-flex items-center cursor-pointer space-x-4">
                    ...
                    <input type="checkbox" wire:model="recording" class="sr-only peer">
                    <div class="relative w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                </label>
                <span data-popover-target="popover-legal-note-header" data-popover-placement="right" class="text-blue-700 hover:text-blue-800 text-sm cursor-pointer">Legal Note</span>
                <div data-popover id="popover-legal-note-header" role="tooltip" class="absolute z-10 invisible inline-block w-64 text-sm text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm opacity-0 max-h-[300px] overflow-y-auto">
                    <div class="px-3">
