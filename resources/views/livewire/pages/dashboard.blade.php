<main>
    ...
    <div class="flex w-full mt-2 ml-2 text-md bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-1 sm:p-6">
      <div class="w-1/3">Data listed in Central Time</div>
      <div  class="w-2/3 float-right">
        <button type="button" class="float-right mr-4 inline-flex items-center justify-center w-1/2 px-3 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-primary-300 sm:w-auto">
    ...
    <div class="grid w-full grid-cols-1 gap-2 m-2 xl:grid-cols-4 2xl:grid-cols-4">       
      ...
      <div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 sm:p-6"><!--Total Calls-->
